...
#define	PB04_BUFFER_TX_EN              4U
#define	PB05_BUFFER_RX_EN              5U
...
#define	LINE_BUFFER_TX_EN              PAL_LINE(GPIOB, 4U)
#define	LINE_BUFFER_RX_EN              PAL_LINE(GPIOB, 5U)
...
#define VAL_GPIOB_MODER                 (PIN_MODE_INPUT(PB00_DIP2_BER) | \
					 ...
					 PIN_MODE_OUTPUT(PB04_BUFFER_TX_EN) | \
					 PIN_MODE_OUTPUT(PB05_BUFFER_RX_EN) | \
...
#define VAL_GPIOB_OTYPER                (PIN_OTYPE_OPENDRAIN(PB00_DIP2_BER) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PB04_BUFFER_TX_EN) | \
					 PIN_OTYPE_PUSHPULL(PB05_BUFFER_RX_EN) | \
...
#define VAL_GPIOB_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PB00_DIP2_BER) | \
					 ...
					 PIN_OSPEED_SPEED_VERYLOW(PB04_BUFFER_TX_EN) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB05_BUFFER_RX_EN) | \
...
#define VAL_GPIOB_PUPDR                 (PIN_PUPDR_PULLDOWN(PB00_DIP2_BER) | \
					 ...
					 PIN_PUPDR_FLOATING(PB04_BUFFER_TX_EN) | \
					 PIN_PUPDR_FLOATING(PB05_BUFFER_RX_EN) | \
...
#define VAL_GPIOB_ODR                   (PIN_ODR_LEVEL_LOW(PB00_DIP2_BER) | \
					 ...
					 PIN_ODR_LEVEL_HIGH(PB04_BUFFER_TX_EN) | \
					 PIN_ODR_LEVEL_HIGH(PB05_BUFFER_RX_EN) | \
...
#define VAL_GPIOB_AFRL			(PIN_AFIO_AF(PB00_DIP2_BER, 0) | \
					 ...
					 PIN_AFIO_AF(PB04_BUFFER_TX_EN, 0) | \
					 PIN_AFIO_AF(PB05_BUFFER_RX_EN, 0) | \
...
#define VAL_GPIOB_ASCR                  (PIN_ASCR_DISABLED(PB00_DIP2_BER) | \
					 ...
					 PIN_ASCR_DISABLED(PB04_BUFFER_TX_EN) | \
					 PIN_ASCR_DISABLED(PB05_BUFFER_RX_EN) | \
...
#define VAL_GPIOB_LOCKR                 (PIN_LOCKR_DISABLED(PB00_DIP2_BER) | \
					 ...
					 PIN_LOCKR_DISABLED(PB04_BUFFER_TX_EN) | \
					 PIN_LOCKR_DISABLED(PB05_BUFFER_RX_EN) | \
