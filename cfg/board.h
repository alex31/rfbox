...
#define	PA03_GRAY_BIT0                 3U
#define	PA04_GRAY_BIT1                 4U
#define	PA05_GRAY_BIT2                 5U
#define	PA06                           6U
#define	PA07_GRAY_BIT3                 7U
#define	PA08_WIND_SPEED_IN             8U
#define	PA09                           9U
#define	PA10_ENCODER_ZERO              10U
#define	PA11                           11U
#define	PA12                           12U
...
#define	PB00_GRAY_BIT4                 0U
#define	PB01_GRAY_BIT5                 1U
#define	PB02                           2U
...
#define	LINE_GRAY_BIT0                 PAL_LINE(GPIOA, 3U)
#define	LINE_GRAY_BIT1                 PAL_LINE(GPIOA, 4U)
#define	LINE_GRAY_BIT2                 PAL_LINE(GPIOA, 5U)
#define	LINE_GRAY_BIT3                 PAL_LINE(GPIOA, 7U)
#define	LINE_WIND_SPEED_IN             PAL_LINE(GPIOA, 8U)
#define	LINE_ENCODER_ZERO              PAL_LINE(GPIOA, 10U)
#define	LINE_SWDIO                     PAL_LINE(GPIOA, 13U)
#define	LINE_SWCLK                     PAL_LINE(GPIOA, 14U)
#define	LINE_VCP_RX                    PAL_LINE(GPIOA, 15U)

#define	LINE_GRAY_BIT4                 PAL_LINE(GPIOB, 0U)
#define	LINE_GRAY_BIT5                 PAL_LINE(GPIOB, 1U)
...
#define VAL_GPIOA_MODER                 (PIN_MODE_ALTERNATE(PA00_RCC_CK_IN) | \
					 ...
					 PIN_MODE_OUTPUT(PA03_GRAY_BIT0) | \
					 PIN_MODE_OUTPUT(PA04_GRAY_BIT1) | \
					 PIN_MODE_OUTPUT(PA05_GRAY_BIT2) | \
					 PIN_MODE_ANALOG(PA06) | \
					 PIN_MODE_OUTPUT(PA07_GRAY_BIT3) | \
					 PIN_MODE_ALTERNATE(PA08_WIND_SPEED_IN) | \
					 PIN_MODE_ANALOG(PA09) | \
					 PIN_MODE_INPUT(PA10_ENCODER_ZERO) | \
...
#define VAL_GPIOA_OTYPER                (PIN_OTYPE_PUSHPULL(PA00_RCC_CK_IN) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PA03_GRAY_BIT0) | \
					 PIN_OTYPE_PUSHPULL(PA04_GRAY_BIT1) | \
					 PIN_OTYPE_PUSHPULL(PA05_GRAY_BIT2) | \
					 PIN_OTYPE_PUSHPULL(PA06) | \
					 PIN_OTYPE_PUSHPULL(PA07_GRAY_BIT3) | \
					 PIN_OTYPE_PUSHPULL(PA08_WIND_SPEED_IN) | \
					 PIN_OTYPE_PUSHPULL(PA09) | \
					 PIN_OTYPE_OPENDRAIN(PA10_ENCODER_ZERO) | \
...
#define VAL_GPIOA_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(PA00_RCC_CK_IN) | \
					 ...
					 PIN_OSPEED_SPEED_LOW(PA03_GRAY_BIT0) | \
					 PIN_OSPEED_SPEED_LOW(PA04_GRAY_BIT1) | \
					 PIN_OSPEED_SPEED_LOW(PA05_GRAY_BIT2) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA06) | \
					 PIN_OSPEED_SPEED_LOW(PA07_GRAY_BIT3) | \
					 PIN_OSPEED_SPEED_HIGH(PA08_WIND_SPEED_IN) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA09) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA10_ENCODER_ZERO) | \
...
#define VAL_GPIOA_PUPDR                 (PIN_PUPDR_FLOATING(PA00_RCC_CK_IN) | \
					 ...
					 PIN_PUPDR_FLOATING(PA03_GRAY_BIT0) | \
					 PIN_PUPDR_FLOATING(PA04_GRAY_BIT1) | \
					 PIN_PUPDR_FLOATING(PA05_GRAY_BIT2) | \
					 PIN_PUPDR_FLOATING(PA06) | \
					 PIN_PUPDR_FLOATING(PA07_GRAY_BIT3) | \
					 PIN_PUPDR_FLOATING(PA08_WIND_SPEED_IN) | \
					 PIN_PUPDR_FLOATING(PA09) | \
					 PIN_PUPDR_FLOATING(PA10_ENCODER_ZERO) | \
...
#define VAL_GPIOA_ODR                   (PIN_ODR_LEVEL_HIGH(PA00_RCC_CK_IN) | \
					 ...
					 PIN_ODR_LEVEL_LOW(PA03_GRAY_BIT0) | \
					 PIN_ODR_LEVEL_LOW(PA04_GRAY_BIT1) | \
					 PIN_ODR_LEVEL_LOW(PA05_GRAY_BIT2) | \
					 PIN_ODR_LEVEL_HIGH(PA06) | \
					 PIN_ODR_LEVEL_LOW(PA07_GRAY_BIT3) | \
					 PIN_ODR_LEVEL_LOW(PA08_WIND_SPEED_IN) | \
					 PIN_ODR_LEVEL_HIGH(PA09) | \
					 PIN_ODR_LEVEL_LOW(PA10_ENCODER_ZERO) | \
...
#define VAL_GPIOA_AFRL			(PIN_AFIO_AF(PA00_RCC_CK_IN, 0) | \
					 ...
					 PIN_AFIO_AF(PA03_GRAY_BIT0, 0) | \
					 PIN_AFIO_AF(PA04_GRAY_BIT1, 0) | \
					 PIN_AFIO_AF(PA05_GRAY_BIT2, 0) | \
					 PIN_AFIO_AF(PA06, 0) | \
					 PIN_AFIO_AF(PA07_GRAY_BIT3, 0))

#define VAL_GPIOA_AFRH			(PIN_AFIO_AF(PA08_WIND_SPEED_IN, 1) | \
					 PIN_AFIO_AF(PA09, 0) | \
					 PIN_AFIO_AF(PA10_ENCODER_ZERO, 0) | \
					 PIN_AFIO_AF(PA11, 0) | \
					 PIN_AFIO_AF(PA12, 0) | \
...
#define VAL_GPIOA_ASCR                  (PIN_ASCR_DISABLED(PA00_RCC_CK_IN) | \
					 ...
					 PIN_ASCR_DISABLED(PA03_GRAY_BIT0) | \
					 PIN_ASCR_DISABLED(PA04_GRAY_BIT1) | \
					 PIN_ASCR_DISABLED(PA05_GRAY_BIT2) | \
					 PIN_ASCR_DISABLED(PA06) | \
					 PIN_ASCR_DISABLED(PA07_GRAY_BIT3) | \
					 PIN_ASCR_DISABLED(PA08_WIND_SPEED_IN) | \
					 PIN_ASCR_DISABLED(PA09) | \
					 PIN_ASCR_DISABLED(PA10_ENCODER_ZERO) | \
...
#define VAL_GPIOA_LOCKR                 (PIN_LOCKR_DISABLED(PA00_RCC_CK_IN) | \
					 ...
					 PIN_LOCKR_DISABLED(PA03_GRAY_BIT0) | \
					 PIN_LOCKR_DISABLED(PA04_GRAY_BIT1) | \
					 PIN_LOCKR_DISABLED(PA05_GRAY_BIT2) | \
					 PIN_LOCKR_DISABLED(PA06) | \
					 PIN_LOCKR_DISABLED(PA07_GRAY_BIT3) | \
					 PIN_LOCKR_DISABLED(PA08_WIND_SPEED_IN) | \
					 PIN_LOCKR_DISABLED(PA09) | \
					 PIN_LOCKR_DISABLED(PA10_ENCODER_ZERO) | \
...
#define VAL_GPIOB_MODER                 (PIN_MODE_OUTPUT(PB00_GRAY_BIT4) | \
					 PIN_MODE_OUTPUT(PB01_GRAY_BIT5) | \
...
#define VAL_GPIOB_OTYPER                (PIN_OTYPE_PUSHPULL(PB00_GRAY_BIT4) | \
					 PIN_OTYPE_PUSHPULL(PB01_GRAY_BIT5) | \
...
#define VAL_GPIOB_OSPEEDR               (PIN_OSPEED_SPEED_LOW(PB00_GRAY_BIT4) | \
					 PIN_OSPEED_SPEED_LOW(PB01_GRAY_BIT5) | \
...
#define VAL_GPIOB_PUPDR                 (PIN_PUPDR_FLOATING(PB00_GRAY_BIT4) | \
					 PIN_PUPDR_FLOATING(PB01_GRAY_BIT5) | \
...
#define VAL_GPIOB_ODR                   (PIN_ODR_LEVEL_LOW(PB00_GRAY_BIT4) | \
					 PIN_ODR_LEVEL_LOW(PB01_GRAY_BIT5) | \
...
#define VAL_GPIOB_AFRL			(PIN_AFIO_AF(PB00_GRAY_BIT4, 0) | \
					 PIN_AFIO_AF(PB01_GRAY_BIT5, 0) | \
					 PIN_AFIO_AF(PB02, 0) | \
...
#define VAL_GPIOB_ASCR                  (PIN_ASCR_DISABLED(PB00_GRAY_BIT4) | \
					 PIN_ASCR_DISABLED(PB01_GRAY_BIT5) | \
...
#define VAL_GPIOB_LOCKR                 (PIN_LOCKR_DISABLED(PB00_GRAY_BIT4) | \
					 PIN_LOCKR_DISABLED(PB01_GRAY_BIT5) | \
