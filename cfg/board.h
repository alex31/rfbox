...
#define	PA06_TDA5150_EN                6U
#define	PA07                           7U
#define	PA08_FRAME_CK                  8U
#define	PA09_FRAME_TX                  9U
#define	PA10_FRAME_RX                  10U
#define	PA11                           11U
#define	PA12_TDA5150_MOSI              12U
...
#define	LINE_TDA5150_EN                PAL_LINE(GPIOA, 6U)
#define	LINE_FRAME_CK                  PAL_LINE(GPIOA, 8U)
#define	LINE_FRAME_TX                  PAL_LINE(GPIOA, 9U)
#define	LINE_FRAME_RX                  PAL_LINE(GPIOA, 10U)
#define	LINE_TDA5150_MOSI              PAL_LINE(GPIOA, 12U)
...
#define VAL_GPIOA_MODER                 (PIN_MODE_ALTERNATE(PA00_RCC_CK_IN) | \
					 ...
					 PIN_MODE_OUTPUT(PA06_TDA5150_EN) | \
					 PIN_MODE_ANALOG(PA07) | \
					 PIN_MODE_ALTERNATE(PA08_FRAME_CK) | \
					 PIN_MODE_ALTERNATE(PA09_FRAME_TX) | \
					 PIN_MODE_ALTERNATE(PA10_FRAME_RX) | \
					 PIN_MODE_ANALOG(PA11) | \
					 PIN_MODE_ALTERNATE(PA12_TDA5150_MOSI) | \
...
#define VAL_GPIOA_OTYPER                (PIN_OTYPE_PUSHPULL(PA00_RCC_CK_IN) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PA06_TDA5150_EN) | \
					 PIN_OTYPE_PUSHPULL(PA07) | \
					 PIN_OTYPE_PUSHPULL(PA08_FRAME_CK) | \
					 PIN_OTYPE_PUSHPULL(PA09_FRAME_TX) | \
					 PIN_OTYPE_PUSHPULL(PA10_FRAME_RX) | \
					 PIN_OTYPE_PUSHPULL(PA11) | \
					 PIN_OTYPE_PUSHPULL(PA12_TDA5150_MOSI) | \
...
#define VAL_GPIOA_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(PA00_RCC_CK_IN) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(PA06_TDA5150_EN) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA07) | \
					 PIN_OSPEED_SPEED_HIGH(PA08_FRAME_CK) | \
					 PIN_OSPEED_SPEED_HIGH(PA09_FRAME_TX) | \
					 PIN_OSPEED_SPEED_HIGH(PA10_FRAME_RX) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA11) | \
					 PIN_OSPEED_SPEED_HIGH(PA12_TDA5150_MOSI) | \
...
#define VAL_GPIOA_PUPDR                 (PIN_PUPDR_FLOATING(PA00_RCC_CK_IN) | \
					 ...
					 PIN_PUPDR_FLOATING(PA06_TDA5150_EN) | \
					 PIN_PUPDR_FLOATING(PA07) | \
					 PIN_PUPDR_FLOATING(PA08_FRAME_CK) | \
					 PIN_PUPDR_FLOATING(PA09_FRAME_TX) | \
					 PIN_PUPDR_FLOATING(PA10_FRAME_RX) | \
					 PIN_PUPDR_FLOATING(PA11) | \
					 PIN_PUPDR_FLOATING(PA12_TDA5150_MOSI) | \
...
#define VAL_GPIOA_AFRL			(PIN_AFIO_AF(PA00_RCC_CK_IN, 0) | \
					 ...
					 PIN_AFIO_AF(PA06_TDA5150_EN, 0) | \
					 PIN_AFIO_AF(PA07, 0))

#define VAL_GPIOA_AFRH			(PIN_AFIO_AF(PA08_FRAME_CK, 7) | \
					 PIN_AFIO_AF(PA09_FRAME_TX, 7) | \
					 PIN_AFIO_AF(PA10_FRAME_RX, 7) | \
					 PIN_AFIO_AF(PA11, 0) | \
					 PIN_AFIO_AF(PA12_TDA5150_MOSI, 5) | \
...
#define AF_PA08_FRAME_CK                 7U
#define AF_LINE_FRAME_CK                 7U
#define AF_PA09_FRAME_TX                 7U
#define AF_LINE_FRAME_TX                 7U
#define AF_PA10_FRAME_RX                 7U
#define AF_LINE_FRAME_RX                 7U
#define AF_PA12_TDA5150_MOSI             5U
#define AF_LINE_TDA5150_MOSI             5U
