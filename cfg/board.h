...
#define	PA04_DIP0_RXTX                 4U
#define	PA05_RADIO_SCK                 5U
#define	PA06_NOTGATE_RX_EN             6U
#define	PA07_OLED_SCL                  7U
#define	PA08_DIP1_POWER                8U
#define	PA09_DIP2_FREQ                 9U
#define	PA10_DIP3_MODE                 10U
#define	PA11_RADIO_MISO                11U
#define	PA12_DIP4_BAUD                 12U
...
#define	LINE_DIP0_RXTX                 PAL_LINE(GPIOA, 4U)
#define	LINE_RADIO_SCK                 PAL_LINE(GPIOA, 5U)
#define	LINE_NOTGATE_RX_EN             PAL_LINE(GPIOA, 6U)
#define	LINE_OLED_SCL                  PAL_LINE(GPIOA, 7U)
#define	LINE_DIP1_POWER                PAL_LINE(GPIOA, 8U)
#define	LINE_DIP2_FREQ                 PAL_LINE(GPIOA, 9U)
#define	LINE_DIP3_MODE                 PAL_LINE(GPIOA, 10U)
#define	LINE_RADIO_MISO                PAL_LINE(GPIOA, 11U)
#define	LINE_DIP4_BAUD                 PAL_LINE(GPIOA, 12U)
...
#define VAL_GPIOA_MODER                 (PIN_MODE_ALTERNATE(PA00_RCC_CK_IN) | \
					 ...
					 PIN_MODE_INPUT(PA04_DIP0_RXTX) | \
					 PIN_MODE_ALTERNATE(PA05_RADIO_SCK) | \
					 PIN_MODE_OUTPUT(PA06_NOTGATE_RX_EN) | \
					 PIN_MODE_ALTERNATE(PA07_OLED_SCL) | \
					 PIN_MODE_INPUT(PA08_DIP1_POWER) | \
					 PIN_MODE_INPUT(PA09_DIP2_FREQ) | \
					 PIN_MODE_INPUT(PA10_DIP3_MODE) | \
					 PIN_MODE_ALTERNATE(PA11_RADIO_MISO) | \
					 PIN_MODE_INPUT(PA12_DIP4_BAUD) | \
...
#define VAL_GPIOA_OTYPER                (PIN_OTYPE_PUSHPULL(PA00_RCC_CK_IN) | \
					 ...
					 PIN_OTYPE_OPENDRAIN(PA04_DIP0_RXTX) | \
					 PIN_OTYPE_PUSHPULL(PA05_RADIO_SCK) | \
					 PIN_OTYPE_PUSHPULL(PA06_NOTGATE_RX_EN) | \
					 PIN_OTYPE_OPENDRAIN(PA07_OLED_SCL) | \
					 PIN_OTYPE_OPENDRAIN(PA08_DIP1_POWER) | \
					 PIN_OTYPE_OPENDRAIN(PA09_DIP2_FREQ) | \
					 PIN_OTYPE_OPENDRAIN(PA10_DIP3_MODE) | \
					 PIN_OTYPE_PUSHPULL(PA11_RADIO_MISO) | \
					 PIN_OTYPE_OPENDRAIN(PA12_DIP4_BAUD) | \
...
#define VAL_GPIOA_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(PA00_RCC_CK_IN) | \
					 ...
					 PIN_OSPEED_SPEED_VERYLOW(PA04_DIP0_RXTX) | \
					 PIN_OSPEED_SPEED_HIGH(PA05_RADIO_SCK) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA06_NOTGATE_RX_EN) | \
					 PIN_OSPEED_SPEED_HIGH(PA07_OLED_SCL) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA08_DIP1_POWER) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA09_DIP2_FREQ) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA10_DIP3_MODE) | \
					 PIN_OSPEED_SPEED_HIGH(PA11_RADIO_MISO) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA12_DIP4_BAUD) | \
...
#define VAL_GPIOA_PUPDR                 (PIN_PUPDR_FLOATING(PA00_RCC_CK_IN) | \
					 ...
					 PIN_PUPDR_PULLDOWN(PA04_DIP0_RXTX) | \
					 PIN_PUPDR_FLOATING(PA05_RADIO_SCK) | \
					 PIN_PUPDR_FLOATING(PA06_NOTGATE_RX_EN) | \
					 PIN_PUPDR_PULLUP(PA07_OLED_SCL) | \
					 PIN_PUPDR_PULLDOWN(PA08_DIP1_POWER) | \
					 PIN_PUPDR_PULLDOWN(PA09_DIP2_FREQ) | \
					 PIN_PUPDR_PULLDOWN(PA10_DIP3_MODE) | \
					 PIN_PUPDR_FLOATING(PA11_RADIO_MISO) | \
					 PIN_PUPDR_PULLDOWN(PA12_DIP4_BAUD) | \
...
#define VAL_GPIOA_ODR                   (PIN_ODR_LEVEL_HIGH(PA00_RCC_CK_IN) | \
					 PIN_ODR_LEVEL_LOW(PA01_NOTGATE_TX_EN) | \
					 PIN_ODR_LEVEL_HIGH(PA02_VCP_TX) | \
					 PIN_ODR_LEVEL_LOW(PA03_RADIO_RESET) | \
					 PIN_ODR_LEVEL_LOW(PA04_DIP0_RXTX) | \
					 PIN_ODR_LEVEL_HIGH(PA05_RADIO_SCK) | \
					 PIN_ODR_LEVEL_LOW(PA06_NOTGATE_RX_EN) | \
					 PIN_ODR_LEVEL_HIGH(PA07_OLED_SCL) | \
					 PIN_ODR_LEVEL_LOW(PA08_DIP1_POWER) | \
					 PIN_ODR_LEVEL_LOW(PA09_DIP2_FREQ) | \
					 PIN_ODR_LEVEL_LOW(PA10_DIP3_MODE) | \
					 PIN_ODR_LEVEL_HIGH(PA11_RADIO_MISO) | \
					 PIN_ODR_LEVEL_LOW(PA12_DIP4_BAUD) | \
...
#define VAL_GPIOA_AFRL			(PIN_AFIO_AF(PA00_RCC_CK_IN, 0) | \
					 ...
					 PIN_AFIO_AF(PA04_DIP0_RXTX, 0) | \
					 PIN_AFIO_AF(PA05_RADIO_SCK, 5) | \
					 PIN_AFIO_AF(PA06_NOTGATE_RX_EN, 0) | \
					 PIN_AFIO_AF(PA07_OLED_SCL, 4))

#define VAL_GPIOA_AFRH			(PIN_AFIO_AF(PA08_DIP1_POWER, 0) | \
					 PIN_AFIO_AF(PA09_DIP2_FREQ, 0) | \
					 PIN_AFIO_AF(PA10_DIP3_MODE, 0) | \
					 PIN_AFIO_AF(PA11_RADIO_MISO, 5) | \
					 PIN_AFIO_AF(PA12_DIP4_BAUD, 0) | \
...
#define VAL_GPIOA_ASCR                  (PIN_ASCR_DISABLED(PA00_RCC_CK_IN) | \
					 ...
					 PIN_ASCR_DISABLED(PA04_DIP0_RXTX) | \
					 PIN_ASCR_DISABLED(PA05_RADIO_SCK) | \
					 PIN_ASCR_DISABLED(PA06_NOTGATE_RX_EN) | \
					 PIN_ASCR_DISABLED(PA07_OLED_SCL) | \
					 PIN_ASCR_DISABLED(PA08_DIP1_POWER) | \
					 PIN_ASCR_DISABLED(PA09_DIP2_FREQ) | \
					 PIN_ASCR_DISABLED(PA10_DIP3_MODE) | \
					 PIN_ASCR_DISABLED(PA11_RADIO_MISO) | \
					 PIN_ASCR_DISABLED(PA12_DIP4_BAUD) | \
...
#define VAL_GPIOA_LOCKR                 (PIN_LOCKR_DISABLED(PA00_RCC_CK_IN) | \
					 ...
					 PIN_LOCKR_DISABLED(PA04_DIP0_RXTX) | \
					 PIN_LOCKR_DISABLED(PA05_RADIO_SCK) | \
					 PIN_LOCKR_DISABLED(PA06_NOTGATE_RX_EN) | \
					 PIN_LOCKR_DISABLED(PA07_OLED_SCL) | \
					 PIN_LOCKR_DISABLED(PA08_DIP1_POWER) | \
					 PIN_LOCKR_DISABLED(PA09_DIP2_FREQ) | \
					 PIN_LOCKR_DISABLED(PA10_DIP3_MODE) | \
					 PIN_LOCKR_DISABLED(PA11_RADIO_MISO) | \
					 PIN_LOCKR_DISABLED(PA12_DIP4_BAUD) | \
