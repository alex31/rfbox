...
#define	PA01_GRAY_BIT0                 1U
#define	PA02_VCP_TX                    2U
#define	PA03_GRAY_BIT1                 3U
#define	PA04_GRAY_BIT2                 4U
#define	PA05_GRAY_BIT3                 5U
#define	PA06_GRAY_BIT4                 6U
#define	PA07_GRAY_BIT5                 7U
#define	PA08_WIND_SPEED_IN             8U
#define	PA09_OLED_SCL                  9U
#define	PA10_OLED_SDA                  10U
#define	PA11_ENCODER_ZERO              11U
#define	PA12                           12U
...
#define	PB01                           1U
#define	PB02                           2U
#define	PB03_WIND_SPEED_OUT            3U
#define	PB04_BUTTON_WINDTEST           4U
#define	PB05_WIND_DIR_CHB              5U
#define	PB06_WIND_DIR_CHA_IT           6U
#define	PB07_WIND_DIR_CHA              7U
#define	PB08                           8U
#define	PB09                           9U
#define	PB10                           10U
#define	PB11                           11U
...
#define	LINE_GRAY_BIT0                 PAL_LINE(GPIOA, 1U)
#define	LINE_VCP_TX                    PAL_LINE(GPIOA, 2U)
#define	LINE_GRAY_BIT1                 PAL_LINE(GPIOA, 3U)
#define	LINE_GRAY_BIT2                 PAL_LINE(GPIOA, 4U)
#define	LINE_GRAY_BIT3                 PAL_LINE(GPIOA, 5U)
#define	LINE_GRAY_BIT4                 PAL_LINE(GPIOA, 6U)
#define	LINE_GRAY_BIT5                 PAL_LINE(GPIOA, 7U)
#define	LINE_WIND_SPEED_IN             PAL_LINE(GPIOA, 8U)
#define	LINE_OLED_SCL                  PAL_LINE(GPIOA, 9U)
#define	LINE_OLED_SDA                  PAL_LINE(GPIOA, 10U)
#define	LINE_ENCODER_ZERO              PAL_LINE(GPIOA, 11U)
#define	LINE_SWDIO                     PAL_LINE(GPIOA, 13U)
#define	LINE_SWCLK                     PAL_LINE(GPIOA, 14U)
#define	LINE_VCP_RX                    PAL_LINE(GPIOA, 15U)

#define	LINE_WIND_SPEED_OUT            PAL_LINE(GPIOB, 3U)
#define	LINE_BUTTON_WINDTEST           PAL_LINE(GPIOB, 4U)
#define	LINE_WIND_DIR_CHB              PAL_LINE(GPIOB, 5U)
#define	LINE_WIND_DIR_CHA_IT           PAL_LINE(GPIOB, 6U)
#define	LINE_WIND_DIR_CHA              PAL_LINE(GPIOB, 7U)
...
#define VAL_GPIOA_MODER                 (PIN_MODE_ALTERNATE(PA00_RCC_CK_IN) | \
					 PIN_MODE_OUTPUT(PA01_GRAY_BIT0) | \
					 PIN_MODE_ALTERNATE(PA02_VCP_TX) | \
					 PIN_MODE_OUTPUT(PA03_GRAY_BIT1) | \
					 PIN_MODE_OUTPUT(PA04_GRAY_BIT2) | \
					 PIN_MODE_OUTPUT(PA05_GRAY_BIT3) | \
					 PIN_MODE_OUTPUT(PA06_GRAY_BIT4) | \
					 PIN_MODE_OUTPUT(PA07_GRAY_BIT5) | \
					 PIN_MODE_ALTERNATE(PA08_WIND_SPEED_IN) | \
					 PIN_MODE_ALTERNATE(PA09_OLED_SCL) | \
					 PIN_MODE_ALTERNATE(PA10_OLED_SDA) | \
					 PIN_MODE_INPUT(PA11_ENCODER_ZERO) | \
...
#define VAL_GPIOA_OTYPER                (PIN_OTYPE_PUSHPULL(PA00_RCC_CK_IN) | \
					 PIN_OTYPE_PUSHPULL(PA01_GRAY_BIT0) | \
					 PIN_OTYPE_PUSHPULL(PA02_VCP_TX) | \
					 PIN_OTYPE_PUSHPULL(PA03_GRAY_BIT1) | \
					 PIN_OTYPE_PUSHPULL(PA04_GRAY_BIT2) | \
					 PIN_OTYPE_PUSHPULL(PA05_GRAY_BIT3) | \
					 PIN_OTYPE_PUSHPULL(PA06_GRAY_BIT4) | \
					 PIN_OTYPE_PUSHPULL(PA07_GRAY_BIT5) | \
					 PIN_OTYPE_PUSHPULL(PA08_WIND_SPEED_IN) | \
					 PIN_OTYPE_OPENDRAIN(PA09_OLED_SCL) | \
					 PIN_OTYPE_OPENDRAIN(PA10_OLED_SDA) | \
					 PIN_OTYPE_OPENDRAIN(PA11_ENCODER_ZERO) | \
...
#define VAL_GPIOA_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(PA00_RCC_CK_IN) | \
					 PIN_OSPEED_SPEED_LOW(PA01_GRAY_BIT0) | \
					 PIN_OSPEED_SPEED_HIGH(PA02_VCP_TX) | \
					 PIN_OSPEED_SPEED_LOW(PA03_GRAY_BIT1) | \
					 PIN_OSPEED_SPEED_LOW(PA04_GRAY_BIT2) | \
					 PIN_OSPEED_SPEED_LOW(PA05_GRAY_BIT3) | \
					 PIN_OSPEED_SPEED_LOW(PA06_GRAY_BIT4) | \
					 PIN_OSPEED_SPEED_LOW(PA07_GRAY_BIT5) | \
					 PIN_OSPEED_SPEED_HIGH(PA08_WIND_SPEED_IN) | \
					 PIN_OSPEED_SPEED_HIGH(PA09_OLED_SCL) | \
					 PIN_OSPEED_SPEED_HIGH(PA10_OLED_SDA) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA11_ENCODER_ZERO) | \
...
#define VAL_GPIOA_PUPDR                 (PIN_PUPDR_FLOATING(PA00_RCC_CK_IN) | \
					 PIN_PUPDR_FLOATING(PA01_GRAY_BIT0) | \
					 PIN_PUPDR_FLOATING(PA02_VCP_TX) | \
					 PIN_PUPDR_FLOATING(PA03_GRAY_BIT1) | \
					 PIN_PUPDR_FLOATING(PA04_GRAY_BIT2) | \
					 PIN_PUPDR_FLOATING(PA05_GRAY_BIT3) | \
					 PIN_PUPDR_FLOATING(PA06_GRAY_BIT4) | \
					 PIN_PUPDR_FLOATING(PA07_GRAY_BIT5) | \
					 PIN_PUPDR_FLOATING(PA08_WIND_SPEED_IN) | \
					 PIN_PUPDR_PULLUP(PA09_OLED_SCL) | \
					 PIN_PUPDR_PULLUP(PA10_OLED_SDA) | \
					 PIN_PUPDR_FLOATING(PA11_ENCODER_ZERO) | \
...
#define VAL_GPIOA_ODR                   (PIN_ODR_LEVEL_HIGH(PA00_RCC_CK_IN) | \
					 PIN_ODR_LEVEL_LOW(PA01_GRAY_BIT0) | \
					 PIN_ODR_LEVEL_HIGH(PA02_VCP_TX) | \
					 PIN_ODR_LEVEL_LOW(PA03_GRAY_BIT1) | \
					 PIN_ODR_LEVEL_LOW(PA04_GRAY_BIT2) | \
					 PIN_ODR_LEVEL_LOW(PA05_GRAY_BIT3) | \
					 PIN_ODR_LEVEL_LOW(PA06_GRAY_BIT4) | \
					 PIN_ODR_LEVEL_LOW(PA07_GRAY_BIT5) | \
					 PIN_ODR_LEVEL_LOW(PA08_WIND_SPEED_IN) | \
					 PIN_ODR_LEVEL_HIGH(PA09_OLED_SCL) | \
					 PIN_ODR_LEVEL_HIGH(PA10_OLED_SDA) | \
					 PIN_ODR_LEVEL_LOW(PA11_ENCODER_ZERO) | \
...
#define VAL_GPIOA_AFRL			(PIN_AFIO_AF(PA00_RCC_CK_IN, 0) | \
					 PIN_AFIO_AF(PA01_GRAY_BIT0, 0) | \
					 PIN_AFIO_AF(PA02_VCP_TX, 7) | \
					 PIN_AFIO_AF(PA03_GRAY_BIT1, 0) | \
					 PIN_AFIO_AF(PA04_GRAY_BIT2, 0) | \
					 PIN_AFIO_AF(PA05_GRAY_BIT3, 0) | \
					 PIN_AFIO_AF(PA06_GRAY_BIT4, 0) | \
					 PIN_AFIO_AF(PA07_GRAY_BIT5, 0))

#define VAL_GPIOA_AFRH			(PIN_AFIO_AF(PA08_WIND_SPEED_IN, 1) | \
					 PIN_AFIO_AF(PA09_OLED_SCL, 4) | \
					 PIN_AFIO_AF(PA10_OLED_SDA, 4) | \
					 PIN_AFIO_AF(PA11_ENCODER_ZERO, 0) | \
					 PIN_AFIO_AF(PA12, 0) | \
...
#define VAL_GPIOA_ASCR                  (PIN_ASCR_DISABLED(PA00_RCC_CK_IN) | \
					 PIN_ASCR_DISABLED(PA01_GRAY_BIT0) | \
					 PIN_ASCR_DISABLED(PA02_VCP_TX) | \
					 PIN_ASCR_DISABLED(PA03_GRAY_BIT1) | \
					 PIN_ASCR_DISABLED(PA04_GRAY_BIT2) | \
					 PIN_ASCR_DISABLED(PA05_GRAY_BIT3) | \
					 PIN_ASCR_DISABLED(PA06_GRAY_BIT4) | \
					 PIN_ASCR_DISABLED(PA07_GRAY_BIT5) | \
					 PIN_ASCR_DISABLED(PA08_WIND_SPEED_IN) | \
					 PIN_ASCR_DISABLED(PA09_OLED_SCL) | \
					 PIN_ASCR_DISABLED(PA10_OLED_SDA) | \
					 PIN_ASCR_DISABLED(PA11_ENCODER_ZERO) | \
...
#define VAL_GPIOA_LOCKR                 (PIN_LOCKR_DISABLED(PA00_RCC_CK_IN) | \
					 PIN_LOCKR_DISABLED(PA01_GRAY_BIT0) | \
					 PIN_LOCKR_DISABLED(PA02_VCP_TX) | \
					 PIN_LOCKR_DISABLED(PA03_GRAY_BIT1) | \
					 PIN_LOCKR_DISABLED(PA04_GRAY_BIT2) | \
					 PIN_LOCKR_DISABLED(PA05_GRAY_BIT3) | \
					 PIN_LOCKR_DISABLED(PA06_GRAY_BIT4) | \
					 PIN_LOCKR_DISABLED(PA07_GRAY_BIT5) | \
					 PIN_LOCKR_DISABLED(PA08_WIND_SPEED_IN) | \
					 PIN_LOCKR_DISABLED(PA09_OLED_SCL) | \
					 PIN_LOCKR_DISABLED(PA10_OLED_SDA) | \
					 PIN_LOCKR_DISABLED(PA11_ENCODER_ZERO) | \
...
#define VAL_GPIOB_MODER                 (PIN_MODE_ANALOG(PB00) | \
					 ...
					 PIN_MODE_OUTPUT(PB03_WIND_SPEED_OUT) | \
					 PIN_MODE_INPUT(PB04_BUTTON_WINDTEST) | \
					 PIN_MODE_ALTERNATE(PB05_WIND_DIR_CHB) | \
					 PIN_MODE_INPUT(PB06_WIND_DIR_CHA_IT) | \
					 PIN_MODE_ALTERNATE(PB07_WIND_DIR_CHA) | \
...
#define VAL_GPIOB_OTYPER                (PIN_OTYPE_PUSHPULL(PB00) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PB03_WIND_SPEED_OUT) | \
					 PIN_OTYPE_OPENDRAIN(PB04_BUTTON_WINDTEST) | \
					 PIN_OTYPE_PUSHPULL(PB05_WIND_DIR_CHB) | \
					 PIN_OTYPE_OPENDRAIN(PB06_WIND_DIR_CHA_IT) | \
					 PIN_OTYPE_PUSHPULL(PB07_WIND_DIR_CHA) | \
...
#define VAL_GPIOB_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PB00) | \
					 ...
					 PIN_OSPEED_SPEED_VERYLOW(PB03_WIND_SPEED_OUT) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB04_BUTTON_WINDTEST) | \
					 PIN_OSPEED_SPEED_HIGH(PB05_WIND_DIR_CHB) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB06_WIND_DIR_CHA_IT) | \
					 PIN_OSPEED_SPEED_HIGH(PB07_WIND_DIR_CHA) | \
...
#define VAL_GPIOB_PUPDR                 (PIN_PUPDR_FLOATING(PB00) | \
					 ...
					 PIN_PUPDR_FLOATING(PB03_WIND_SPEED_OUT) | \
					 PIN_PUPDR_PULLUP(PB04_BUTTON_WINDTEST) | \
					 PIN_PUPDR_FLOATING(PB05_WIND_DIR_CHB) | \
					 PIN_PUPDR_FLOATING(PB06_WIND_DIR_CHA_IT) | \
					 PIN_PUPDR_FLOATING(PB07_WIND_DIR_CHA) | \
...
#define VAL_GPIOB_ODR                   (PIN_ODR_LEVEL_HIGH(PB00) | \
					 ...
					 PIN_ODR_LEVEL_LOW(PB03_WIND_SPEED_OUT) | \
					 PIN_ODR_LEVEL_LOW(PB04_BUTTON_WINDTEST) | \
					 PIN_ODR_LEVEL_LOW(PB05_WIND_DIR_CHB) | \
					 PIN_ODR_LEVEL_LOW(PB06_WIND_DIR_CHA_IT) | \
					 PIN_ODR_LEVEL_LOW(PB07_WIND_DIR_CHA) | \
...
#define VAL_GPIOB_AFRL			(PIN_AFIO_AF(PB00, 0) | \
					 PIN_AFIO_AF(PB01, 0) | \
					 PIN_AFIO_AF(PB02, 0) | \
					 PIN_AFIO_AF(PB03_WIND_SPEED_OUT, 0) | \
					 PIN_AFIO_AF(PB04_BUTTON_WINDTEST, 0) | \
					 PIN_AFIO_AF(PB05_WIND_DIR_CHB, 1) | \
					 PIN_AFIO_AF(PB06_WIND_DIR_CHA_IT, 0) | \
					 PIN_AFIO_AF(PB07_WIND_DIR_CHA, 1))
...
#define VAL_GPIOB_ASCR                  (PIN_ASCR_DISABLED(PB00) | \
					 ...
					 PIN_ASCR_DISABLED(PB03_WIND_SPEED_OUT) | \
					 PIN_ASCR_DISABLED(PB04_BUTTON_WINDTEST) | \
					 PIN_ASCR_DISABLED(PB05_WIND_DIR_CHB) | \
					 PIN_ASCR_DISABLED(PB06_WIND_DIR_CHA_IT) | \
					 PIN_ASCR_DISABLED(PB07_WIND_DIR_CHA) | \
...
#define VAL_GPIOB_LOCKR                 (PIN_LOCKR_DISABLED(PB00) | \
					 ...
					 PIN_LOCKR_DISABLED(PB03_WIND_SPEED_OUT) | \
					 PIN_LOCKR_DISABLED(PB04_BUTTON_WINDTEST) | \
					 PIN_LOCKR_DISABLED(PB05_WIND_DIR_CHB) | \
					 PIN_LOCKR_DISABLED(PB06_WIND_DIR_CHA_IT) | \
					 PIN_LOCKR_DISABLED(PB07_WIND_DIR_CHA) | \
...
#define AF_PA08_WIND_SPEED_IN            1U
#define AF_LINE_WIND_SPEED_IN            1U
...
#define AF_PB05_WIND_DIR_CHB             1U
#define AF_LINE_WIND_DIR_CHB             1U
#define AF_PB07_WIND_DIR_CHA             1U
#define AF_LINE_WIND_DIR_CHA             1U
...
#define WIND_SPEED_OUT_TIM	 2
#define WIND_SPEED_OUT_TIM_FN	 CH
#define WIND_SPEED_OUT_TIM_CH	 2
#define WIND_SPEED_OUT_TIM_AF	 1
