...
#define	LINE_NOT_GATE_IN               PAL_LINE(GPIOA, 1U)
...
#define	LINE_NOT_GATE_OUT              PAL_LINE(GPIOA, 6U)
...
#define	LINE_DIP4_UNUSED               PAL_LINE(GPIOA, 12U)
...
#define	LINE_METEO_RX                  PAL_LINE(GPIOB, 7U)
...
#define VAL_GPIOA_MODER                 (PIN_MODE_ALTERNATE(PA00_RCC_CK_IN) | \
					 PIN_MODE_ANALOG(PA01_NOT_GATE_IN) | \
					 ...
					 PIN_MODE_ALTERNATE(PA06_NOT_GATE_OUT) | \
					 ...
					 PIN_MODE_INPUT(PA12_DIP4_UNUSED) | \
...
#define VAL_GPIOA_OTYPER                (PIN_OTYPE_PUSHPULL(PA00_RCC_CK_IN) | \
					 PIN_OTYPE_PUSHPULL(PA01_NOT_GATE_IN) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PA06_NOT_GATE_OUT) | \
					 ...
					 PIN_OTYPE_OPENDRAIN(PA12_DIP4_UNUSED) | \
...
#define VAL_GPIOA_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(PA00_RCC_CK_IN) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA01_NOT_GATE_IN) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(PA06_NOT_GATE_OUT) | \
					 ...
					 PIN_OSPEED_SPEED_VERYLOW(PA12_DIP4_UNUSED) | \
...
#define VAL_GPIOA_PUPDR                 (PIN_PUPDR_FLOATING(PA00_RCC_CK_IN) | \
					 PIN_PUPDR_PULLUP(PA01_NOT_GATE_IN) | \
					 ...
					 PIN_PUPDR_FLOATING(PA06_NOT_GATE_OUT) | \
					 ...
					 PIN_PUPDR_PULLDOWN(PA12_DIP4_UNUSED) | \
...
#define VAL_GPIOA_ODR                   (PIN_ODR_LEVEL_HIGH(PA00_RCC_CK_IN) | \
					 PIN_ODR_LEVEL_LOW(PA01_NOT_GATE_IN) | \
					 ...
					 PIN_ODR_LEVEL_LOW(PA06_NOT_GATE_OUT) | \
					 ...
					 PIN_ODR_LEVEL_LOW(PA12_DIP4_UNUSED) | \
...
#define VAL_GPIOA_AFRH			(PIN_AFIO_AF(PA08_DIP1_POWER, 0) | \
					 ...
					 PIN_AFIO_AF(PA12_DIP4_UNUSED, 0) | \
...
#define VAL_GPIOA_ASCR                  (PIN_ASCR_DISABLED(PA00_RCC_CK_IN) | \
					 PIN_ASCR_ENABLED(PA01_NOT_GATE_IN) | \
					 ...
					 PIN_ASCR_DISABLED(PA06_NOT_GATE_OUT) | \
					 ...
					 PIN_ASCR_DISABLED(PA12_DIP4_UNUSED) | \
...
#define VAL_GPIOA_LOCKR                 (PIN_LOCKR_DISABLED(PA00_RCC_CK_IN) | \
					 PIN_LOCKR_DISABLED(PA01_NOT_GATE_IN) | \
					 ...
					 PIN_LOCKR_DISABLED(PA06_NOT_GATE_OUT) | \
					 ...
					 PIN_LOCKR_DISABLED(PA12_DIP4_UNUSED) | \
...
#define VAL_GPIOB_MODER                 (PIN_MODE_OUTPUT(PB00_RADIO_CS) | \
					 ...
					 PIN_MODE_ALTERNATE(PB07_METEO_RX) | \
...
#define VAL_GPIOB_OTYPER                (PIN_OTYPE_PUSHPULL(PB00_RADIO_CS) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PB07_METEO_RX) | \
...
#define VAL_GPIOB_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PB00_RADIO_CS) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(PB07_METEO_RX) | \
...
#define VAL_GPIOB_PUPDR                 (PIN_PUPDR_FLOATING(PB00_RADIO_CS) | \
					 ...
					 PIN_PUPDR_FLOATING(PB07_METEO_RX) | \
...
#define VAL_GPIOB_ODR                   (PIN_ODR_LEVEL_HIGH(PB00_RADIO_CS) | \
					 ...
					 PIN_ODR_LEVEL_HIGH(PB07_METEO_RX) | \
...
#define VAL_GPIOB_ASCR                  (PIN_ASCR_DISABLED(PB00_RADIO_CS) | \
					 ...
					 PIN_ASCR_DISABLED(PB07_METEO_RX) | \
...
#define VAL_GPIOB_LOCKR                 (PIN_LOCKR_DISABLED(PB00_RADIO_CS) | \
					 ...
					 PIN_LOCKR_DISABLED(PB07_METEO_RX) | \
...
#define AF_PA06_NOT_GATE_OUT             6U
#define AF_LINE_NOT_GATE_OUT             6U
...
#define AF_PB07_METEO_RX                 7U
#define AF_LINE_METEO_RX                 7U
