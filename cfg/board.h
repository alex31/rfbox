...
#define	PA01_RADIO_RESET               1U
#define	PA02_VCP_TX                    2U
#define	PA03_RADIO_CS                  3U
#define	PA04_DIP0_RFENABLE             4U
#define	PA05_RADIO_SCK                 5U
#define	PA06_RADIO_MISO                6U
#define	PA07_RADIO_MOSI                7U
#define	PA08_DIP4_RXTX                 8U
#define	PA09_OLED_SCL                  9U
#define	PA10_OLED_SDA                  10U
#define	PA11_DIP5_PWRLVL               11U
#define	PA12_DIP3_BERBAUD              12U
#define	PA13_SWDIO                     13U
#define	PA14_SWCLK                     14U
#define	PA15_VCP_RX                    15U

#define	PB00_DIP2_BER                  0U
#define	PB01_DIP1_FREQ                 1U
#define	PB02                           2U
#define	PB03_BUFFER_INVERT             3U
#define	PB04_NOTGATE_TX_EN             4U
#define	PB05_NOTGATE_RX_EN             5U
...
#define	LINE_RADIO_RESET               PAL_LINE(GPIOA, 1U)
...
#define	LINE_RADIO_MISO                PAL_LINE(GPIOA, 6U)
#define	LINE_RADIO_MOSI                PAL_LINE(GPIOA, 7U)
#define	LINE_DIP4_RXTX                 PAL_LINE(GPIOA, 8U)
#define	LINE_OLED_SCL                  PAL_LINE(GPIOA, 9U)
#define	LINE_OLED_SDA                  PAL_LINE(GPIOA, 10U)
#define	LINE_DIP5_PWRLVL               PAL_LINE(GPIOA, 11U)
#define	LINE_DIP3_BERBAUD              PAL_LINE(GPIOA, 12U)
#define	LINE_SWDIO                     PAL_LINE(GPIOA, 13U)
#define	LINE_SWCLK                     PAL_LINE(GPIOA, 14U)
#define	LINE_VCP_RX                    PAL_LINE(GPIOA, 15U)

#define	LINE_DIP2_BER                  PAL_LINE(GPIOB, 0U)
#define	LINE_DIP1_FREQ                 PAL_LINE(GPIOB, 1U)
#define	LINE_BUFFER_INVERT             PAL_LINE(GPIOB, 3U)
#define	LINE_NOTGATE_TX_EN             PAL_LINE(GPIOB, 4U)
#define	LINE_NOTGATE_RX_EN             PAL_LINE(GPIOB, 5U)
...
#define VAL_GPIOA_MODER                 (PIN_MODE_ALTERNATE(PA00_RCC_CK_IN) | \
					 PIN_MODE_INPUT(PA01_RADIO_RESET) | \
					 PIN_MODE_ALTERNATE(PA02_VCP_TX) | \
					 PIN_MODE_OUTPUT(PA03_RADIO_CS) | \
					 PIN_MODE_INPUT(PA04_DIP0_RFENABLE) | \
					 PIN_MODE_ALTERNATE(PA05_RADIO_SCK) | \
					 PIN_MODE_ALTERNATE(PA06_RADIO_MISO) | \
					 PIN_MODE_ALTERNATE(PA07_RADIO_MOSI) | \
					 PIN_MODE_INPUT(PA08_DIP4_RXTX) | \
					 PIN_MODE_ALTERNATE(PA09_OLED_SCL) | \
					 PIN_MODE_ALTERNATE(PA10_OLED_SDA) | \
					 PIN_MODE_INPUT(PA11_DIP5_PWRLVL) | \
					 PIN_MODE_INPUT(PA12_DIP3_BERBAUD) | \
...
#define VAL_GPIOA_OTYPER                (PIN_OTYPE_PUSHPULL(PA00_RCC_CK_IN) | \
					 PIN_OTYPE_OPENDRAIN(PA01_RADIO_RESET) | \
					 PIN_OTYPE_PUSHPULL(PA02_VCP_TX) | \
					 PIN_OTYPE_PUSHPULL(PA03_RADIO_CS) | \
					 PIN_OTYPE_OPENDRAIN(PA04_DIP0_RFENABLE) | \
					 PIN_OTYPE_PUSHPULL(PA05_RADIO_SCK) | \
					 PIN_OTYPE_PUSHPULL(PA06_RADIO_MISO) | \
					 PIN_OTYPE_PUSHPULL(PA07_RADIO_MOSI) | \
					 PIN_OTYPE_OPENDRAIN(PA08_DIP4_RXTX) | \
					 PIN_OTYPE_OPENDRAIN(PA09_OLED_SCL) | \
					 PIN_OTYPE_OPENDRAIN(PA10_OLED_SDA) | \
					 PIN_OTYPE_OPENDRAIN(PA11_DIP5_PWRLVL) | \
					 PIN_OTYPE_OPENDRAIN(PA12_DIP3_BERBAUD) | \
...
#define VAL_GPIOA_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(PA00_RCC_CK_IN) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA01_RADIO_RESET) | \
					 PIN_OSPEED_SPEED_HIGH(PA02_VCP_TX) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA03_RADIO_CS) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA04_DIP0_RFENABLE) | \
					 PIN_OSPEED_SPEED_HIGH(PA05_RADIO_SCK) | \
					 PIN_OSPEED_SPEED_HIGH(PA06_RADIO_MISO) | \
					 PIN_OSPEED_SPEED_HIGH(PA07_RADIO_MOSI) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA08_DIP4_RXTX) | \
					 PIN_OSPEED_SPEED_HIGH(PA09_OLED_SCL) | \
					 PIN_OSPEED_SPEED_HIGH(PA10_OLED_SDA) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA11_DIP5_PWRLVL) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA12_DIP3_BERBAUD) | \
...
#define VAL_GPIOA_PUPDR                 (PIN_PUPDR_FLOATING(PA00_RCC_CK_IN) | \
					 PIN_PUPDR_FLOATING(PA01_RADIO_RESET) | \
					 PIN_PUPDR_FLOATING(PA02_VCP_TX) | \
					 PIN_PUPDR_FLOATING(PA03_RADIO_CS) | \
					 PIN_PUPDR_PULLDOWN(PA04_DIP0_RFENABLE) | \
					 PIN_PUPDR_FLOATING(PA05_RADIO_SCK) | \
					 PIN_PUPDR_FLOATING(PA06_RADIO_MISO) | \
					 PIN_PUPDR_FLOATING(PA07_RADIO_MOSI) | \
					 PIN_PUPDR_PULLDOWN(PA08_DIP4_RXTX) | \
					 PIN_PUPDR_PULLUP(PA09_OLED_SCL) | \
					 PIN_PUPDR_PULLUP(PA10_OLED_SDA) | \
					 PIN_PUPDR_PULLDOWN(PA11_DIP5_PWRLVL) | \
					 PIN_PUPDR_PULLDOWN(PA12_DIP3_BERBAUD) | \
...
#define VAL_GPIOA_ODR                   (PIN_ODR_LEVEL_HIGH(PA00_RCC_CK_IN) | \
					 PIN_ODR_LEVEL_LOW(PA01_RADIO_RESET) | \
					 PIN_ODR_LEVEL_HIGH(PA02_VCP_TX) | \
					 PIN_ODR_LEVEL_HIGH(PA03_RADIO_CS) | \
					 PIN_ODR_LEVEL_LOW(PA04_DIP0_RFENABLE) | \
					 PIN_ODR_LEVEL_HIGH(PA05_RADIO_SCK) | \
					 PIN_ODR_LEVEL_HIGH(PA06_RADIO_MISO) | \
					 PIN_ODR_LEVEL_HIGH(PA07_RADIO_MOSI) | \
					 PIN_ODR_LEVEL_LOW(PA08_DIP4_RXTX) | \
					 PIN_ODR_LEVEL_HIGH(PA09_OLED_SCL) | \
					 PIN_ODR_LEVEL_HIGH(PA10_OLED_SDA) | \
					 PIN_ODR_LEVEL_LOW(PA11_DIP5_PWRLVL) | \
					 PIN_ODR_LEVEL_LOW(PA12_DIP3_BERBAUD) | \
...
#define VAL_GPIOA_AFRL			(PIN_AFIO_AF(PA00_RCC_CK_IN, 0) | \
					 PIN_AFIO_AF(PA01_RADIO_RESET, 0) | \
					 PIN_AFIO_AF(PA02_VCP_TX, 7) | \
					 PIN_AFIO_AF(PA03_RADIO_CS, 0) | \
					 PIN_AFIO_AF(PA04_DIP0_RFENABLE, 0) | \
					 PIN_AFIO_AF(PA05_RADIO_SCK, 5) | \
					 PIN_AFIO_AF(PA06_RADIO_MISO, 5) | \
					 PIN_AFIO_AF(PA07_RADIO_MOSI, 5))

#define VAL_GPIOA_AFRH			(PIN_AFIO_AF(PA08_DIP4_RXTX, 0) | \
					 PIN_AFIO_AF(PA09_OLED_SCL, 4) | \
					 PIN_AFIO_AF(PA10_OLED_SDA, 4) | \
					 PIN_AFIO_AF(PA11_DIP5_PWRLVL, 0) | \
					 PIN_AFIO_AF(PA12_DIP3_BERBAUD, 0) | \
...
#define VAL_GPIOA_ASCR                  (PIN_ASCR_DISABLED(PA00_RCC_CK_IN) | \
					 PIN_ASCR_DISABLED(PA01_RADIO_RESET) | \
					 PIN_ASCR_DISABLED(PA02_VCP_TX) | \
					 PIN_ASCR_DISABLED(PA03_RADIO_CS) | \
					 PIN_ASCR_DISABLED(PA04_DIP0_RFENABLE) | \
					 PIN_ASCR_DISABLED(PA05_RADIO_SCK) | \
					 PIN_ASCR_DISABLED(PA06_RADIO_MISO) | \
					 PIN_ASCR_DISABLED(PA07_RADIO_MOSI) | \
					 PIN_ASCR_DISABLED(PA08_DIP4_RXTX) | \
					 PIN_ASCR_DISABLED(PA09_OLED_SCL) | \
					 PIN_ASCR_DISABLED(PA10_OLED_SDA) | \
					 PIN_ASCR_DISABLED(PA11_DIP5_PWRLVL) | \
					 PIN_ASCR_DISABLED(PA12_DIP3_BERBAUD) | \
...
#define VAL_GPIOA_LOCKR                 (PIN_LOCKR_DISABLED(PA00_RCC_CK_IN) | \
					 PIN_LOCKR_DISABLED(PA01_RADIO_RESET) | \
					 PIN_LOCKR_DISABLED(PA02_VCP_TX) | \
					 PIN_LOCKR_DISABLED(PA03_RADIO_CS) | \
					 PIN_LOCKR_DISABLED(PA04_DIP0_RFENABLE) | \
					 PIN_LOCKR_DISABLED(PA05_RADIO_SCK) | \
					 PIN_LOCKR_DISABLED(PA06_RADIO_MISO) | \
					 PIN_LOCKR_DISABLED(PA07_RADIO_MOSI) | \
					 PIN_LOCKR_DISABLED(PA08_DIP4_RXTX) | \
					 PIN_LOCKR_DISABLED(PA09_OLED_SCL) | \
					 PIN_LOCKR_DISABLED(PA10_OLED_SDA) | \
					 PIN_LOCKR_DISABLED(PA11_DIP5_PWRLVL) | \
					 PIN_LOCKR_DISABLED(PA12_DIP3_BERBAUD) | \
					 PIN_LOCKR_DISABLED(PA13_SWDIO) | \
					 PIN_LOCKR_DISABLED(PA14_SWCLK) | \
					 PIN_LOCKR_DISABLED(PA15_VCP_RX))

#define VAL_GPIOB_MODER                 (PIN_MODE_INPUT(PB00_DIP2_BER) | \
					 PIN_MODE_INPUT(PB01_DIP1_FREQ) | \
					 PIN_MODE_ANALOG(PB02) | \
					 PIN_MODE_OUTPUT(PB03_BUFFER_INVERT) | \
					 PIN_MODE_OUTPUT(PB04_NOTGATE_TX_EN) | \
					 PIN_MODE_OUTPUT(PB05_NOTGATE_RX_EN) | \
...
#define VAL_GPIOB_OTYPER                (PIN_OTYPE_OPENDRAIN(PB00_DIP2_BER) | \
					 PIN_OTYPE_OPENDRAIN(PB01_DIP1_FREQ) | \
					 PIN_OTYPE_PUSHPULL(PB02) | \
					 PIN_OTYPE_PUSHPULL(PB03_BUFFER_INVERT) | \
					 PIN_OTYPE_PUSHPULL(PB04_NOTGATE_TX_EN) | \
					 PIN_OTYPE_PUSHPULL(PB05_NOTGATE_RX_EN) | \
...
#define VAL_GPIOB_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PB00_DIP2_BER) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB01_DIP1_FREQ) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB02) | \
					 PIN_OSPEED_SPEED_LOW(PB03_BUFFER_INVERT) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB04_NOTGATE_TX_EN) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB05_NOTGATE_RX_EN) | \
...
#define VAL_GPIOB_PUPDR                 (PIN_PUPDR_PULLDOWN(PB00_DIP2_BER) | \
					 PIN_PUPDR_PULLDOWN(PB01_DIP1_FREQ) | \
					 PIN_PUPDR_FLOATING(PB02) | \
					 PIN_PUPDR_FLOATING(PB03_BUFFER_INVERT) | \
					 PIN_PUPDR_FLOATING(PB04_NOTGATE_TX_EN) | \
					 PIN_PUPDR_FLOATING(PB05_NOTGATE_RX_EN) | \
...
#define VAL_GPIOB_ODR                   (PIN_ODR_LEVEL_LOW(PB00_DIP2_BER) | \
					 PIN_ODR_LEVEL_LOW(PB01_DIP1_FREQ) | \
					 PIN_ODR_LEVEL_HIGH(PB02) | \
					 PIN_ODR_LEVEL_LOW(PB03_BUFFER_INVERT) | \
					 PIN_ODR_LEVEL_HIGH(PB04_NOTGATE_TX_EN) | \
					 PIN_ODR_LEVEL_HIGH(PB05_NOTGATE_RX_EN) | \
...
#define VAL_GPIOB_AFRL			(PIN_AFIO_AF(PB00_DIP2_BER, 0) | \
					 PIN_AFIO_AF(PB01_DIP1_FREQ, 0) | \
					 PIN_AFIO_AF(PB02, 0) | \
					 PIN_AFIO_AF(PB03_BUFFER_INVERT, 0) | \
					 PIN_AFIO_AF(PB04_NOTGATE_TX_EN, 0) | \
					 PIN_AFIO_AF(PB05_NOTGATE_RX_EN, 0) | \
...
#define VAL_GPIOB_ASCR                  (PIN_ASCR_DISABLED(PB00_DIP2_BER) | \
					 PIN_ASCR_DISABLED(PB01_DIP1_FREQ) | \
					 PIN_ASCR_DISABLED(PB02) | \
					 PIN_ASCR_DISABLED(PB03_BUFFER_INVERT) | \
					 PIN_ASCR_DISABLED(PB04_NOTGATE_TX_EN) | \
					 PIN_ASCR_DISABLED(PB05_NOTGATE_RX_EN) | \
...
#define VAL_GPIOB_LOCKR                 (PIN_LOCKR_DISABLED(PB00_DIP2_BER) | \
					 PIN_LOCKR_DISABLED(PB01_DIP1_FREQ) | \
					 PIN_LOCKR_DISABLED(PB02) | \
					 PIN_LOCKR_DISABLED(PB03_BUFFER_INVERT) | \
					 PIN_LOCKR_DISABLED(PB04_NOTGATE_TX_EN) | \
					 PIN_LOCKR_DISABLED(PB05_NOTGATE_RX_EN) | \
...
#define AF_PA06_RADIO_MISO               5U
#define AF_LINE_RADIO_MISO               5U
#define AF_PA07_RADIO_MOSI               5U
