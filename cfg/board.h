...
#define	PB05_WIND_DIR_CHA              5U
#define	PB06_WIND_DIR_CHA_IT           6U
#define	PB07_WIND_DIR_CHB              7U
#define	PB08                           8U
#define	PB09                           9U
#define	PB10                           10U
#define	PB11                           11U
...
#define	LINE_WIND_DIR_CHA              PAL_LINE(GPIOB, 5U)
#define	LINE_WIND_DIR_CHA_IT           PAL_LINE(GPIOB, 6U)
#define	LINE_WIND_DIR_CHB              PAL_LINE(GPIOB, 7U)
...
#define VAL_GPIOB_MODER                 (PIN_MODE_ANALOG(PB00) | \
					 ...
					 PIN_MODE_ALTERNATE(PB05_WIND_DIR_CHA) | \
					 PIN_MODE_INPUT(PB06_WIND_DIR_CHA_IT) | \
					 PIN_MODE_ALTERNATE(PB07_WIND_DIR_CHB) | \
...
#define VAL_GPIOB_OTYPER                (PIN_OTYPE_PUSHPULL(PB00) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PB05_WIND_DIR_CHA) | \
					 PIN_OTYPE_OPENDRAIN(PB06_WIND_DIR_CHA_IT) | \
					 PIN_OTYPE_PUSHPULL(PB07_WIND_DIR_CHB) | \
...
#define VAL_GPIOB_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PB00) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(PB05_WIND_DIR_CHA) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB06_WIND_DIR_CHA_IT) | \
					 PIN_OSPEED_SPEED_HIGH(PB07_WIND_DIR_CHB) | \
...
#define VAL_GPIOB_PUPDR                 (PIN_PUPDR_FLOATING(PB00) | \
					 ...
					 PIN_PUPDR_FLOATING(PB05_WIND_DIR_CHA) | \
					 PIN_PUPDR_FLOATING(PB06_WIND_DIR_CHA_IT) | \
					 PIN_PUPDR_FLOATING(PB07_WIND_DIR_CHB) | \
...
#define VAL_GPIOB_ODR                   (PIN_ODR_LEVEL_HIGH(PB00) | \
					 ...
					 PIN_ODR_LEVEL_LOW(PB05_WIND_DIR_CHA) | \
					 PIN_ODR_LEVEL_LOW(PB06_WIND_DIR_CHA_IT) | \
					 PIN_ODR_LEVEL_LOW(PB07_WIND_DIR_CHB) | \
...
#define VAL_GPIOB_AFRL			(PIN_AFIO_AF(PB00, 0) | \
					 ...
					 PIN_AFIO_AF(PB05_WIND_DIR_CHA, 1) | \
					 PIN_AFIO_AF(PB06_WIND_DIR_CHA_IT, 0) | \
					 PIN_AFIO_AF(PB07_WIND_DIR_CHB, 1))
...
#define VAL_GPIOB_ASCR                  (PIN_ASCR_DISABLED(PB00) | \
					 ...
					 PIN_ASCR_DISABLED(PB05_WIND_DIR_CHA) | \
					 PIN_ASCR_DISABLED(PB06_WIND_DIR_CHA_IT) | \
					 PIN_ASCR_DISABLED(PB07_WIND_DIR_CHB) | \
...
#define VAL_GPIOB_LOCKR                 (PIN_LOCKR_DISABLED(PB00) | \
					 ...
					 PIN_LOCKR_DISABLED(PB05_WIND_DIR_CHA) | \
					 PIN_LOCKR_DISABLED(PB06_WIND_DIR_CHA_IT) | \
					 PIN_LOCKR_DISABLED(PB07_WIND_DIR_CHB) | \
...
#define AF_PB05_WIND_DIR_CHA             1U
#define AF_LINE_WIND_DIR_CHA             1U
#define AF_PB07_WIND_DIR_CHB             1U
