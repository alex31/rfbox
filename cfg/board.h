...
#define	PA08_DIP1_CH0                  8U
#define	PA09_DIP2_CH1                  9U
#define	PA10_DIP3_CH2                  10U
#define	PA11_RADIO_MISO                11U
#define	PA12_DIP4_CH3                  12U
...
#define	LINE_DIP1_CH0                  PAL_LINE(GPIOA, 8U)
#define	LINE_DIP2_CH1                  PAL_LINE(GPIOA, 9U)
#define	LINE_DIP3_CH2                  PAL_LINE(GPIOA, 10U)
#define	LINE_RADIO_MISO                PAL_LINE(GPIOA, 11U)
#define	LINE_DIP4_CH3                  PAL_LINE(GPIOA, 12U)
...
#define	LINE_METEO_TX                  PAL_LINE(GPIOB, 6U)
...
#define VAL_GPIOA_MODER                 (PIN_MODE_ALTERNATE(PA00_RCC_CK_IN) | \
					 ...
					 PIN_MODE_INPUT(PA08_DIP1_CH0) | \
					 PIN_MODE_INPUT(PA09_DIP2_CH1) | \
					 PIN_MODE_INPUT(PA10_DIP3_CH2) | \
					 PIN_MODE_ALTERNATE(PA11_RADIO_MISO) | \
					 PIN_MODE_INPUT(PA12_DIP4_CH3) | \
...
#define VAL_GPIOA_OTYPER                (PIN_OTYPE_PUSHPULL(PA00_RCC_CK_IN) | \
					 ...
					 PIN_OTYPE_OPENDRAIN(PA08_DIP1_CH0) | \
					 PIN_OTYPE_OPENDRAIN(PA09_DIP2_CH1) | \
					 PIN_OTYPE_OPENDRAIN(PA10_DIP3_CH2) | \
					 PIN_OTYPE_PUSHPULL(PA11_RADIO_MISO) | \
					 PIN_OTYPE_OPENDRAIN(PA12_DIP4_CH3) | \
...
#define VAL_GPIOA_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(PA00_RCC_CK_IN) | \
					 ...
					 PIN_OSPEED_SPEED_VERYLOW(PA08_DIP1_CH0) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA09_DIP2_CH1) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA10_DIP3_CH2) | \
					 PIN_OSPEED_SPEED_HIGH(PA11_RADIO_MISO) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA12_DIP4_CH3) | \
...
#define VAL_GPIOA_PUPDR                 (PIN_PUPDR_FLOATING(PA00_RCC_CK_IN) | \
					 ...
					 PIN_PUPDR_FLOATING(PA04_DIP0_RXTX) | \
					 PIN_PUPDR_FLOATING(PA05_RADIO_SCK) | \
					 PIN_PUPDR_FLOATING(PA06_NOT_GATE_OUT) | \
					 PIN_PUPDR_PULLUP(PA07_OLED_SCL) | \
					 PIN_PUPDR_FLOATING(PA08_DIP1_CH0) | \
					 PIN_PUPDR_FLOATING(PA09_DIP2_CH1) | \
					 PIN_PUPDR_FLOATING(PA10_DIP3_CH2) | \
					 PIN_PUPDR_FLOATING(PA11_RADIO_MISO) | \
					 PIN_PUPDR_FLOATING(PA12_DIP4_CH3) | \
...
#define VAL_GPIOA_ODR                   (PIN_ODR_LEVEL_HIGH(PA00_RCC_CK_IN) | \
					 ...
					 PIN_ODR_LEVEL_LOW(PA08_DIP1_CH0) | \
					 PIN_ODR_LEVEL_LOW(PA09_DIP2_CH1) | \
					 PIN_ODR_LEVEL_LOW(PA10_DIP3_CH2) | \
					 PIN_ODR_LEVEL_HIGH(PA11_RADIO_MISO) | \
					 PIN_ODR_LEVEL_LOW(PA12_DIP4_CH3) | \
...
#define VAL_GPIOA_AFRH			(PIN_AFIO_AF(PA08_DIP1_CH0, 0) | \
					 PIN_AFIO_AF(PA09_DIP2_CH1, 0) | \
					 PIN_AFIO_AF(PA10_DIP3_CH2, 0) | \
					 PIN_AFIO_AF(PA11_RADIO_MISO, 5) | \
					 PIN_AFIO_AF(PA12_DIP4_CH3, 0) | \
...
#define VAL_GPIOA_ASCR                  (PIN_ASCR_DISABLED(PA00_RCC_CK_IN) | \
					 ...
					 PIN_ASCR_DISABLED(PA08_DIP1_CH0) | \
					 PIN_ASCR_DISABLED(PA09_DIP2_CH1) | \
					 PIN_ASCR_DISABLED(PA10_DIP3_CH2) | \
					 PIN_ASCR_DISABLED(PA11_RADIO_MISO) | \
					 PIN_ASCR_DISABLED(PA12_DIP4_CH3) | \
...
#define VAL_GPIOA_LOCKR                 (PIN_LOCKR_DISABLED(PA00_RCC_CK_IN) | \
					 ...
					 PIN_LOCKR_DISABLED(PA08_DIP1_CH0) | \
					 PIN_LOCKR_DISABLED(PA09_DIP2_CH1) | \
					 PIN_LOCKR_DISABLED(PA10_DIP3_CH2) | \
					 PIN_LOCKR_DISABLED(PA11_RADIO_MISO) | \
					 PIN_LOCKR_DISABLED(PA12_DIP4_CH3) | \
...
#define VAL_GPIOB_MODER                 (PIN_MODE_OUTPUT(PB00_RADIO_CS) | \
					 ...
					 PIN_MODE_ALTERNATE(PB06_METEO_TX) | \
...
#define VAL_GPIOB_OTYPER                (PIN_OTYPE_PUSHPULL(PB00_RADIO_CS) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PB06_METEO_TX) | \
...
#define VAL_GPIOB_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PB00_RADIO_CS) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(PB06_METEO_TX) | \
...
#define VAL_GPIOB_PUPDR                 (PIN_PUPDR_FLOATING(PB00_RADIO_CS) | \
					 ...
					 PIN_PUPDR_FLOATING(PB06_METEO_TX) | \
...
#define VAL_GPIOB_ODR                   (PIN_ODR_LEVEL_HIGH(PB00_RADIO_CS) | \
					 ...
					 PIN_ODR_LEVEL_HIGH(PB06_METEO_TX) | \
...
#define VAL_GPIOB_ASCR                  (PIN_ASCR_DISABLED(PB00_RADIO_CS) | \
					 ...
					 PIN_ASCR_DISABLED(PB06_METEO_TX) | \
...
#define VAL_GPIOB_LOCKR                 (PIN_LOCKR_DISABLED(PB00_RADIO_CS) | \
					 ...
					 PIN_LOCKR_DISABLED(PB06_METEO_TX) | \
...
#define AF_PB06_METEO_TX                 7U
#define AF_LINE_METEO_TX                 7U
