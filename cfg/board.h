...
#define	PA01_NOTGATE_TX_EN             1U
#define	PA02_VCP_TX                    2U
#define	PA03_RADIO_RESET               3U
#define	PA04_DIP0_RFENABLE             4U
#define	PA05_RADIO_SCK                 5U
#define	PA06_NOTGATE_RX_EN             6U
#define	PA07_OLED_SCL                  7U
#define	PA08_DIP1_RXTX                 8U
#define	PA09_DIP2_PWRLVL               9U
#define	PA10_DIP3_FREQ                 10U
#define	PA11_RADIO_MISO                11U
#define	PA12_DIP4_BER                  12U
#define	PA13_SWDIO                     13U
#define	PA14_SWCLK                     14U
#define	PA15_VCP_RX                    15U

#define	PB00_RADIO_CS                  0U
#define	PB01_DIP5_BERBAUD              1U
#define	PB02                           2U
#define	PB03_LED_GREEN                 3U
#define	PB04_OLED_SDA                  4U
#define	PB05_RADIO_MOSI                5U
#define	PB06_EXTVCP_TX                 6U
#define	PB07_EXTVCP_RX                 7U
#define	PB08                           8U
#define	PB09                           9U
#define	PB10                           10U
#define	PB11                           11U
...
#define	LINE_NOTGATE_TX_EN             PAL_LINE(GPIOA, 1U)
#define	LINE_VCP_TX                    PAL_LINE(GPIOA, 2U)
#define	LINE_RADIO_RESET               PAL_LINE(GPIOA, 3U)
#define	LINE_DIP0_RFENABLE             PAL_LINE(GPIOA, 4U)
#define	LINE_RADIO_SCK                 PAL_LINE(GPIOA, 5U)
#define	LINE_NOTGATE_RX_EN             PAL_LINE(GPIOA, 6U)
#define	LINE_OLED_SCL                  PAL_LINE(GPIOA, 7U)
#define	LINE_DIP1_RXTX                 PAL_LINE(GPIOA, 8U)
#define	LINE_DIP2_PWRLVL               PAL_LINE(GPIOA, 9U)
#define	LINE_DIP3_FREQ                 PAL_LINE(GPIOA, 10U)
#define	LINE_RADIO_MISO                PAL_LINE(GPIOA, 11U)
#define	LINE_DIP4_BER                  PAL_LINE(GPIOA, 12U)
#define	LINE_SWDIO                     PAL_LINE(GPIOA, 13U)
#define	LINE_SWCLK                     PAL_LINE(GPIOA, 14U)
#define	LINE_VCP_RX                    PAL_LINE(GPIOA, 15U)

#define	LINE_RADIO_CS                  PAL_LINE(GPIOB, 0U)
#define	LINE_DIP5_BERBAUD              PAL_LINE(GPIOB, 1U)
#define	LINE_LED_GREEN                 PAL_LINE(GPIOB, 3U)
#define	LINE_OLED_SDA                  PAL_LINE(GPIOB, 4U)
#define	LINE_RADIO_MOSI                PAL_LINE(GPIOB, 5U)
#define	LINE_EXTVCP_TX                 PAL_LINE(GPIOB, 6U)
#define	LINE_EXTVCP_RX                 PAL_LINE(GPIOB, 7U)
...
#define VAL_GPIOA_MODER                 (PIN_MODE_ALTERNATE(PA00_RCC_CK_IN) | \
					 PIN_MODE_OUTPUT(PA01_NOTGATE_TX_EN) | \
					 PIN_MODE_ALTERNATE(PA02_VCP_TX) | \
					 PIN_MODE_INPUT(PA03_RADIO_RESET) | \
					 PIN_MODE_INPUT(PA04_DIP0_RFENABLE) | \
					 PIN_MODE_ALTERNATE(PA05_RADIO_SCK) | \
					 PIN_MODE_OUTPUT(PA06_NOTGATE_RX_EN) | \
					 PIN_MODE_ALTERNATE(PA07_OLED_SCL) | \
					 PIN_MODE_INPUT(PA08_DIP1_RXTX) | \
					 PIN_MODE_INPUT(PA09_DIP2_PWRLVL) | \
					 PIN_MODE_INPUT(PA10_DIP3_FREQ) | \
					 PIN_MODE_ALTERNATE(PA11_RADIO_MISO) | \
					 PIN_MODE_INPUT(PA12_DIP4_BER) | \
...
#define VAL_GPIOA_OTYPER                (PIN_OTYPE_PUSHPULL(PA00_RCC_CK_IN) | \
					 PIN_OTYPE_PUSHPULL(PA01_NOTGATE_TX_EN) | \
					 PIN_OTYPE_PUSHPULL(PA02_VCP_TX) | \
					 PIN_OTYPE_OPENDRAIN(PA03_RADIO_RESET) | \
					 PIN_OTYPE_OPENDRAIN(PA04_DIP0_RFENABLE) | \
					 PIN_OTYPE_PUSHPULL(PA05_RADIO_SCK) | \
					 PIN_OTYPE_PUSHPULL(PA06_NOTGATE_RX_EN) | \
					 PIN_OTYPE_OPENDRAIN(PA07_OLED_SCL) | \
					 PIN_OTYPE_OPENDRAIN(PA08_DIP1_RXTX) | \
					 PIN_OTYPE_OPENDRAIN(PA09_DIP2_PWRLVL) | \
					 PIN_OTYPE_OPENDRAIN(PA10_DIP3_FREQ) | \
					 PIN_OTYPE_PUSHPULL(PA11_RADIO_MISO) | \
					 PIN_OTYPE_OPENDRAIN(PA12_DIP4_BER) | \
...
#define VAL_GPIOA_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(PA00_RCC_CK_IN) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA01_NOTGATE_TX_EN) | \
					 PIN_OSPEED_SPEED_HIGH(PA02_VCP_TX) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA03_RADIO_RESET) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA04_DIP0_RFENABLE) | \
					 PIN_OSPEED_SPEED_HIGH(PA05_RADIO_SCK) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA06_NOTGATE_RX_EN) | \
					 PIN_OSPEED_SPEED_HIGH(PA07_OLED_SCL) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA08_DIP1_RXTX) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA09_DIP2_PWRLVL) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA10_DIP3_FREQ) | \
					 PIN_OSPEED_SPEED_HIGH(PA11_RADIO_MISO) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA12_DIP4_BER) | \
...
#define VAL_GPIOA_PUPDR                 (PIN_PUPDR_FLOATING(PA00_RCC_CK_IN) | \
					 PIN_PUPDR_FLOATING(PA01_NOTGATE_TX_EN) | \
					 PIN_PUPDR_FLOATING(PA02_VCP_TX) | \
					 PIN_PUPDR_FLOATING(PA03_RADIO_RESET) | \
					 PIN_PUPDR_PULLUP(PA04_DIP0_RFENABLE) | \
					 PIN_PUPDR_FLOATING(PA05_RADIO_SCK) | \
					 PIN_PUPDR_FLOATING(PA06_NOTGATE_RX_EN) | \
					 PIN_PUPDR_PULLUP(PA07_OLED_SCL) | \
					 PIN_PUPDR_PULLUP(PA08_DIP1_RXTX) | \
					 PIN_PUPDR_PULLUP(PA09_DIP2_PWRLVL) | \
					 PIN_PUPDR_PULLUP(PA10_DIP3_FREQ) | \
					 PIN_PUPDR_FLOATING(PA11_RADIO_MISO) | \
					 PIN_PUPDR_PULLUP(PA12_DIP4_BER) | \
...
#define VAL_GPIOA_ODR                   (PIN_ODR_LEVEL_HIGH(PA00_RCC_CK_IN) | \
					 PIN_ODR_LEVEL_HIGH(PA01_NOTGATE_TX_EN) | \
					 PIN_ODR_LEVEL_HIGH(PA02_VCP_TX) | \
					 PIN_ODR_LEVEL_LOW(PA03_RADIO_RESET) | \
					 PIN_ODR_LEVEL_LOW(PA04_DIP0_RFENABLE) | \
					 PIN_ODR_LEVEL_HIGH(PA05_RADIO_SCK) | \
					 PIN_ODR_LEVEL_HIGH(PA06_NOTGATE_RX_EN) | \
					 PIN_ODR_LEVEL_HIGH(PA07_OLED_SCL) | \
					 PIN_ODR_LEVEL_LOW(PA08_DIP1_RXTX) | \
					 PIN_ODR_LEVEL_LOW(PA09_DIP2_PWRLVL) | \
					 PIN_ODR_LEVEL_LOW(PA10_DIP3_FREQ) | \
					 PIN_ODR_LEVEL_HIGH(PA11_RADIO_MISO) | \
					 PIN_ODR_LEVEL_LOW(PA12_DIP4_BER) | \
...
#define VAL_GPIOA_AFRL			(PIN_AFIO_AF(PA00_RCC_CK_IN, 0) | \
					 PIN_AFIO_AF(PA01_NOTGATE_TX_EN, 0) | \
					 PIN_AFIO_AF(PA02_VCP_TX, 7) | \
					 PIN_AFIO_AF(PA03_RADIO_RESET, 0) | \
					 PIN_AFIO_AF(PA04_DIP0_RFENABLE, 0) | \
					 PIN_AFIO_AF(PA05_RADIO_SCK, 5) | \
					 PIN_AFIO_AF(PA06_NOTGATE_RX_EN, 0) | \
					 PIN_AFIO_AF(PA07_OLED_SCL, 4))

#define VAL_GPIOA_AFRH			(PIN_AFIO_AF(PA08_DIP1_RXTX, 0) | \
					 PIN_AFIO_AF(PA09_DIP2_PWRLVL, 0) | \
					 PIN_AFIO_AF(PA10_DIP3_FREQ, 0) | \
					 PIN_AFIO_AF(PA11_RADIO_MISO, 5) | \
					 PIN_AFIO_AF(PA12_DIP4_BER, 0) | \
...
#define VAL_GPIOA_ASCR                  (PIN_ASCR_DISABLED(PA00_RCC_CK_IN) | \
					 PIN_ASCR_DISABLED(PA01_NOTGATE_TX_EN) | \
					 PIN_ASCR_DISABLED(PA02_VCP_TX) | \
					 PIN_ASCR_DISABLED(PA03_RADIO_RESET) | \
					 PIN_ASCR_DISABLED(PA04_DIP0_RFENABLE) | \
					 PIN_ASCR_DISABLED(PA05_RADIO_SCK) | \
					 PIN_ASCR_DISABLED(PA06_NOTGATE_RX_EN) | \
					 PIN_ASCR_DISABLED(PA07_OLED_SCL) | \
					 PIN_ASCR_DISABLED(PA08_DIP1_RXTX) | \
					 PIN_ASCR_DISABLED(PA09_DIP2_PWRLVL) | \
					 PIN_ASCR_DISABLED(PA10_DIP3_FREQ) | \
					 PIN_ASCR_DISABLED(PA11_RADIO_MISO) | \
					 PIN_ASCR_DISABLED(PA12_DIP4_BER) | \
...
#define VAL_GPIOA_LOCKR                 (PIN_LOCKR_DISABLED(PA00_RCC_CK_IN) | \
					 PIN_LOCKR_DISABLED(PA01_NOTGATE_TX_EN) | \
					 PIN_LOCKR_DISABLED(PA02_VCP_TX) | \
					 PIN_LOCKR_DISABLED(PA03_RADIO_RESET) | \
					 PIN_LOCKR_DISABLED(PA04_DIP0_RFENABLE) | \
					 PIN_LOCKR_DISABLED(PA05_RADIO_SCK) | \
					 PIN_LOCKR_DISABLED(PA06_NOTGATE_RX_EN) | \
					 PIN_LOCKR_DISABLED(PA07_OLED_SCL) | \
					 PIN_LOCKR_DISABLED(PA08_DIP1_RXTX) | \
					 PIN_LOCKR_DISABLED(PA09_DIP2_PWRLVL) | \
					 PIN_LOCKR_DISABLED(PA10_DIP3_FREQ) | \
					 PIN_LOCKR_DISABLED(PA11_RADIO_MISO) | \
					 PIN_LOCKR_DISABLED(PA12_DIP4_BER) | \
					 PIN_LOCKR_DISABLED(PA13_SWDIO) | \
					 PIN_LOCKR_DISABLED(PA14_SWCLK) | \
					 PIN_LOCKR_DISABLED(PA15_VCP_RX))

#define VAL_GPIOB_MODER                 (PIN_MODE_OUTPUT(PB00_RADIO_CS) | \
					 PIN_MODE_INPUT(PB01_DIP5_BERBAUD) | \
					 PIN_MODE_ANALOG(PB02) | \
					 PIN_MODE_OUTPUT(PB03_LED_GREEN) | \
					 PIN_MODE_ALTERNATE(PB04_OLED_SDA) | \
					 PIN_MODE_ALTERNATE(PB05_RADIO_MOSI) | \
					 PIN_MODE_ALTERNATE(PB06_EXTVCP_TX) | \
					 PIN_MODE_ALTERNATE(PB07_EXTVCP_RX) | \
...
#define VAL_GPIOB_OTYPER                (PIN_OTYPE_PUSHPULL(PB00_RADIO_CS) | \
					 PIN_OTYPE_OPENDRAIN(PB01_DIP5_BERBAUD) | \
					 PIN_OTYPE_PUSHPULL(PB02) | \
					 PIN_OTYPE_PUSHPULL(PB03_LED_GREEN) | \
					 PIN_OTYPE_OPENDRAIN(PB04_OLED_SDA) | \
					 PIN_OTYPE_PUSHPULL(PB05_RADIO_MOSI) | \
					 PIN_OTYPE_PUSHPULL(PB06_EXTVCP_TX) | \
					 PIN_OTYPE_PUSHPULL(PB07_EXTVCP_RX) | \
...
#define VAL_GPIOB_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PB00_RADIO_CS) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB01_DIP5_BERBAUD) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB02) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB03_LED_GREEN) | \
					 PIN_OSPEED_SPEED_HIGH(PB04_OLED_SDA) | \
					 PIN_OSPEED_SPEED_HIGH(PB05_RADIO_MOSI) | \
					 PIN_OSPEED_SPEED_HIGH(PB06_EXTVCP_TX) | \
					 PIN_OSPEED_SPEED_HIGH(PB07_EXTVCP_RX) | \
...
#define VAL_GPIOB_PUPDR                 (PIN_PUPDR_FLOATING(PB00_RADIO_CS) | \
					 PIN_PUPDR_PULLUP(PB01_DIP5_BERBAUD) | \
					 PIN_PUPDR_FLOATING(PB02) | \
					 PIN_PUPDR_FLOATING(PB03_LED_GREEN) | \
					 PIN_PUPDR_PULLUP(PB04_OLED_SDA) | \
					 PIN_PUPDR_FLOATING(PB05_RADIO_MOSI) | \
					 PIN_PUPDR_FLOATING(PB06_EXTVCP_TX) | \
					 PIN_PUPDR_FLOATING(PB07_EXTVCP_RX) | \
...
#define VAL_GPIOB_ODR                   (PIN_ODR_LEVEL_HIGH(PB00_RADIO_CS) | \
					 PIN_ODR_LEVEL_LOW(PB01_DIP5_BERBAUD) | \
					 PIN_ODR_LEVEL_HIGH(PB02) | \
					 PIN_ODR_LEVEL_LOW(PB03_LED_GREEN) | \
					 PIN_ODR_LEVEL_HIGH(PB04_OLED_SDA) | \
					 PIN_ODR_LEVEL_HIGH(PB05_RADIO_MOSI) | \
					 PIN_ODR_LEVEL_HIGH(PB06_EXTVCP_TX) | \
					 PIN_ODR_LEVEL_HIGH(PB07_EXTVCP_RX) | \
...
#define VAL_GPIOB_AFRL			(PIN_AFIO_AF(PB00_RADIO_CS, 0) | \
					 PIN_AFIO_AF(PB01_DIP5_BERBAUD, 0) | \
					 PIN_AFIO_AF(PB02, 0) | \
					 PIN_AFIO_AF(PB03_LED_GREEN, 0) | \
					 PIN_AFIO_AF(PB04_OLED_SDA, 4) | \
					 PIN_AFIO_AF(PB05_RADIO_MOSI, 5) | \
					 PIN_AFIO_AF(PB06_EXTVCP_TX, 7) | \
					 PIN_AFIO_AF(PB07_EXTVCP_RX, 7))
...
#define VAL_GPIOB_ASCR                  (PIN_ASCR_DISABLED(PB00_RADIO_CS) | \
					 PIN_ASCR_DISABLED(PB01_DIP5_BERBAUD) | \
					 PIN_ASCR_DISABLED(PB02) | \
					 PIN_ASCR_DISABLED(PB03_LED_GREEN) | \
					 PIN_ASCR_DISABLED(PB04_OLED_SDA) | \
					 PIN_ASCR_DISABLED(PB05_RADIO_MOSI) | \
					 PIN_ASCR_DISABLED(PB06_EXTVCP_TX) | \
					 PIN_ASCR_DISABLED(PB07_EXTVCP_RX) | \
...
#define VAL_GPIOB_LOCKR                 (PIN_LOCKR_DISABLED(PB00_RADIO_CS) | \
					 PIN_LOCKR_DISABLED(PB01_DIP5_BERBAUD) | \
					 PIN_LOCKR_DISABLED(PB02) | \
					 PIN_LOCKR_DISABLED(PB03_LED_GREEN) | \
					 PIN_LOCKR_DISABLED(PB04_OLED_SDA) | \
					 PIN_LOCKR_DISABLED(PB05_RADIO_MOSI) | \
					 PIN_LOCKR_DISABLED(PB06_EXTVCP_TX) | \
					 PIN_LOCKR_DISABLED(PB07_EXTVCP_RX) | \
...
#define AF_PA05_RADIO_SCK                5U
#define AF_LINE_RADIO_SCK                5U
#define AF_PA07_OLED_SCL                 4U
#define AF_LINE_OLED_SCL                 4U
#define AF_PA11_RADIO_MISO               5U
#define AF_LINE_RADIO_MISO               5U
...
#define AF_PB04_OLED_SDA                 4U
#define AF_LINE_OLED_SDA                 4U
#define AF_PB05_RADIO_MOSI               5U
#define AF_LINE_RADIO_MOSI               5U
#define AF_PB06_EXTVCP_TX                7U
#define AF_LINE_EXTVCP_TX                7U
#define AF_PB07_EXTVCP_RX                7U
#define AF_LINE_EXTVCP_RX                7U
