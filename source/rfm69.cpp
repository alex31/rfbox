...
void Rfm69OokRadio::checkRestartRxNeeded()
{
  ...
  if ( ((rssi < -100.0f) and (lnaGain < -24.0f)) // misbehave: low rssi and low gain
       or
       ((rssi > -60.0f) and (lnaGain > -24.0f)) // misbehave: high rssi and high gain
       or
       (rssi < -110.0f) // very low rssi : no emission on the channel
       //      or
